...
<section class="hero">
    <div class="hero-content container">
        ...
        <p>Akses materi pelajaran yang disediakan oleh guru untuk siswa</p>
    </div>
</section>
...
<div class="container py-5">
    ...
    <div class="text-center mb-5">
        ...
        <p class="section-subtitle">Materi pembelajaran terbaru yang dapat dipelajari siswa.</p>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6 d-flex">
            <div class="card card-custom w-100 p-4 d-flex flex-column">
                ...
                <a href="uploads/materi/<?= htmlspecialchars($row['file_materi']); ?>" 
